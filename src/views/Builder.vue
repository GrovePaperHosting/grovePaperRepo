            ...
            <div class="w100 is-flex">
              ...
              <div v-if="pagesBookStructure.length>0" class="book mx-3">
                ...
                <div class="page" style="max-width: 522px;max-height: 684px" :class="`page${index}`"
                  ...
                  <div class="side side1">
                    <div>
                      <component v-if="page.length>1" :is="`${page[1].type}`" :data="page[1].data"
                                 class="pdf"></component>
                    </div>
                  </div>
                </div>
  ...
  methods: {
    ...
    */
    ...
    calcBookStructure() {
      ...
      console.log('this.pagesBookStructure2', this.pagesBookStructure)
      ...
      this.pagesBookStructure[this.pagesBookStructure.length - 1][1] = {type: 'endPage', category: 'fillpage', data: this.finalValue[2].selection}
