<template>
  <div id="g-3_-School-L-box" class="ai2html">
    <div id="g-3_-School-L-Artboard_1" class="g-artboard" style="max-width: 522px;max-height: 684px" data-aspect-ratio="0.763" data-min-width="0">
      <div style="padding: 0 0 131.0345% 0;"></div>
      <img id="g-3_-School-L-Artboard_1-img" class="g-aiImg" alt="" src="./3_-School-L-Artboard_1.png"/>
...
#g-3_-School-L-box ,
#g-3_-School-L-box .g-artboard {
  margin:0 auto;
}
#g-3_-School-L-box p {
  margin:0;
}
#g-3_-School-L-box .g-aiAbs {
  position:absolute;
}
#g-3_-School-L-box .g-aiImg {
  position:absolute;
  top:0;
  display:block;
  width:100% !important;
}
#g-3_-School-L-box .g-aiSymbol {
  position: absolute;
  box-sizing: border-box;
}
#g-3_-School-L-box .g-aiPointText p { white-space: nowrap; }
#g-3_-School-L-Artboard_1 {
  position:relative;
  overflow:hidden;
}
#g-3_-School-L-Artboard_1 p {
  font-weight:500;
  line-height:11px;
  height:auto;
...
#g-3_-School-L-Artboard_1 .g-pstyle0 {
  height:11px;
  text-align:center;
