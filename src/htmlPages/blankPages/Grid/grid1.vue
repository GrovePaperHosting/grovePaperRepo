<template>
  <div id="g-4_-Grid-L-box" class="ai2html">

    <!-- Artboard: Artboard_1 -->
    <div id="g-4_-Grid-L-Artboard_1" class="g-artboard" style="max-width: 522px;max-height: 684px" data-aspect-ratio="0.763" data-min-width="0">
      <div style="padding: 0 0 131.0345% 0;"></div>
      <img id="g-4_-Grid-L-Artboard_1-img" class="g-aiImg" alt="" src="./4_-Grid-L-Artboard_1.png"/>
...
#g-4_-Grid-L-box ,
#g-4_-Grid-L-box .g-artboard {
  margin:0 auto;
}
#g-4_-Grid-L-box p {
  margin:0;
}
#g-4_-Grid-L-box .g-aiAbs {
  position:absolute;
}
#g-4_-Grid-L-box .g-aiImg {
  position:absolute;
  top:0;
  display:block;
  width:100% !important;
}
#g-4_-Grid-L-box .g-aiSymbol {
  position: absolute;
  box-sizing: border-box;
}
#g-4_-Grid-L-box .g-aiPointText p { white-space: nowrap; }
#g-4_-Grid-L-Artboard_1 {
  position:relative;
  overflow:hidden;
}
#g-4_-Grid-L-Artboard_1 p {
  font-weight:500;
  line-height:11px;
  height:auto;
...
#g-4_-Grid-L-Artboard_1 .g-pstyle0 {
  height:11px;
  text-align:center;
