<template>
  <div id="g-2_-Task-Triage-L-box" class="ai2html">
    <div id="g-2_-Task-Triage-L-Artboard_1" class="g-artboard" style="max-width: 522px;max-height: 684px" data-aspect-ratio="0.763" data-min-width="0">
      <div style="padding: 0 0 131.0345% 0;"></div>
      <img id="g-2_-Task-Triage-L-Artboard_1-img" class="g-aiImg" alt="" src="./2_-Task-Triage-L-Artboard_1.png"/>
...
#g-2_-Task-Triage-L-box ,
#g-2_-Task-Triage-L-box .g-artboard {
  margin:0 auto;
}
#g-2_-Task-Triage-L-box p {
  margin:0;
}
#g-2_-Task-Triage-L-box .g-aiAbs {
  position:absolute;
}
#g-2_-Task-Triage-L-box .g-aiImg {
  position:absolute;
  top:0;
  display:block;
  width:100% !important;
}
#g-2_-Task-Triage-L-box .g-aiSymbol {
  position: absolute;
  box-sizing: border-box;
}
#g-2_-Task-Triage-L-box .g-aiPointText p { white-space: nowrap; }
#g-2_-Task-Triage-L-Artboard_1 {
  position:relative;
  overflow:hidden;
}
#g-2_-Task-Triage-L-Artboard_1 p {
  font-weight:500;
  line-height:11px;
  height:auto;
...
#g-2_-Task-Triage-L-Artboard_1 .g-pstyle0 {
  height:11px;
  text-align:center;
