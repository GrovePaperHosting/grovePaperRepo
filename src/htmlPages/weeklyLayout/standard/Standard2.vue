<template>
  <div id="g-Weekly-Layouts-box" class="ai2html">

    <!-- Artboard: Artboard_3 -->
    <div id="g-Weekly-Layouts-Artboard_3" class="g-artboard" style="max-width: 522px;max-height: 684px" data-aspect-ratio="0.763" data-min-width="0">
      <div style="padding: 0 0 131.0345% 0;"></div>
      <img id="g-Weekly-Layouts-Artboard_3-img" class="g-aiImg" alt="" src="./Weekly-Layouts-Artboard_3.png"/>
      <div id="g-ai0-1" class="g-Layer_1 g-aiAbs g-aiPointText" style="top:5.779%;margin-top:-7.5px;left:66.1746%;width:29px;">
        <p class="g-pstyle0">S</p>
      </div>
      <div id="g-ai0-2" class="g-Layer_1 g-aiAbs g-aiPointText" style="top:5.779%;margin-top:-7.5px;left:70.0452%;width:33px;">
        <p class="g-pstyle0">M</p>
      </div>
      <div id="g-ai0-3" class="g-Layer_1 g-aiAbs g-aiPointText" style="top:5.779%;margin-top:-7.5px;left:74.8397%;width:30px;">
        <p class="g-pstyle0">T</p>
      </div>
      <div id="g-ai0-4" class="g-Layer_1 g-aiAbs g-aiPointText" style="top:5.779%;margin-top:-7.5px;left:78.9584%;width:35px;">
        <p class="g-pstyle0">W</p>
      </div>
      <div id="g-ai0-5" class="g-Layer_1 g-aiAbs g-aiPointText" style="top:5.779%;margin-top:-7.5px;left:83.969%;width:30px;">
        <p class="g-pstyle0">T</p>
      </div>
      <div id="g-ai0-6" class="g-Layer_1 g-aiAbs g-aiPointText" style="top:5.779%;margin-top:-7.5px;left:88.0878%;width:29px;">
        <p class="g-pstyle0">F</p>
      </div>
      <div id="g-ai0-7" class="g-Layer_1 g-aiAbs g-aiPointText" style="top:5.779%;margin-top:-7.5px;left:92.0824%;width:29px;">
        <p class="g-pstyle0">S</p>
      </div>
      ...
      <div id="g-ai0-43" class="g-Layer_1 g-aiAbs g-aiPointText" style="top:48.469%;margin-top:-7.5px;left:14.3884%;width:62px;">
        <p class="g-pstyle1">To Do</p>
      </div>
      <div id="g-ai0-44" class="g-Layer_1 g-aiAbs g-aiPointText" style="top:74.931%;margin-top:-7.5px;left:11.1874%;width:94px;">
        <p class="g-pstyle1">Next Week</p>
      </div>
    </div>
  </div>
</template>
...
<style scoped>
#g-Weekly-Layouts-box ,
#g-Weekly-Layouts-box .g-artboard {
  margin:0 auto;
}
#g-Weekly-Layouts-box p {
  margin:0;
}
#g-Weekly-Layouts-box .g-aiAbs {
  position:absolute;
}
#g-Weekly-Layouts-box .g-aiImg {
  position:absolute;
  top:0;
  display:block;
  width:100% !important;
}
#g-Weekly-Layouts-box .g-aiSymbol {
  position: absolute;
  box-sizing: border-box;
}
#g-Weekly-Layouts-box .g-aiPointText p { white-space: nowrap; }
#g-Weekly-Layouts-Artboard_3 {
  position:relative;
  overflow:hidden;
}
#g-Weekly-Layouts-Artboard_3 p {
  font-weight:500;
  line-height:14px;
  height:auto;
...
#g-Weekly-Layouts-Artboard_3 .g-pstyle0 {
  height:14px;
  text-transform:uppercase;
}
#g-Weekly-Layouts-Artboard_3 .g-pstyle1 {
  height:14px;
  text-transform:uppercase;
  color:rgb(0,0,0);
}
