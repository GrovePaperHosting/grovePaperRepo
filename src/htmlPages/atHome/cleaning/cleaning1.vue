<template>
  <div id="g-2_-Cleaning-L-box" class="ai2html">
    <div id="g-2_-Cleaning-L-Artboard_1" class="g-artboard" style="max-width: 522px;max-height: 684px"
...
#g-2_-Cleaning-L-box,
#g-2_-Cleaning-L-box .g-artboard {
  margin: 0 auto;
}

#g-2_-Cleaning-L-box p {
  margin: 0;
}

#g-2_-Cleaning-L-box .g-aiAbs {
  position: absolute;
}

#g-2_-Cleaning-L-box .g-aiImg {
  position: absolute;
  top: 0;
  display: block;
  width: 100% !important;
...
#g-2_-Cleaning-L-box .g-aiSymbol {
  position: absolute;
  box-sizing: border-box;
}

#g-2_-Cleaning-L-box .g-aiPointText p {
  white-space: nowrap;
}

#g-2_-Cleaning-L-Artboard_1 {
  position: relative;
  overflow: hidden;
}

#g-2_-Cleaning-L-Artboard_1 p {
  font-weight: 500;
  line-height: 11px;
  height: auto;
