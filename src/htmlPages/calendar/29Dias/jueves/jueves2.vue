<template>
  <div id="g-29---Thursday-R-box" class="ai2html">

    <!-- Artboard: Artboard_2 -->
    <div id="g-29---Thursday-R-Artboard_2" class="g-artboard" style="max-width: 522px;max-height: 684px" data-aspect-ratio="0.763" data-min-width="0">
      <div style="padding: 0 0 131.0345% 0;"></div>
      <img id="g-29---Thursday-R-Artboard_2-img" class="g-aiImg" alt="" src="./29---Thursday-R-Artboard_2.png"/>
...
#g-29---Thursday-R-box ,
#g-29---Thursday-R-box .g-artboard {
  margin:0 auto;
}
#g-29---Thursday-R-box p {
  margin:0;
}
#g-29---Thursday-R-box .g-aiAbs {
  position:absolute;
}
#g-29---Thursday-R-box .g-aiImg {
  position:absolute;
  top:0;
  display:block;
  width:100% !important;
}
#g-29---Thursday-R-box .g-aiSymbol {
  position: absolute;
  box-sizing: border-box;
}
#g-29---Thursday-R-box .g-aiPointText p { white-space: nowrap; }
#g-29---Thursday-R-Artboard_2 {
  position:relative;
  overflow:hidden;
}
#g-29---Thursday-R-Artboard_2 p {
  font-weight:500;
  line-height:11px;
  height:auto;
...
#g-29---Thursday-R-Artboard_2 .g-pstyle0 {
  line-height:9px;
  height:9px;
  font-size:7px;
  text-align:center;
...
#g-29---Thursday-R-Artboard_2 .g-pstyle1 {
  height:11px;
  text-transform:uppercase;
}
